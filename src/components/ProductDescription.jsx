        ...
        <div className="container mx-auto px-4">
            ...
            <ol role="list" className="flex items-center">
              ...
              <li className="text-left">
                <div className="flex items-center">
                  ...
                  <div className="-m-1">
                    <a href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800"> New Arrivals </a>
                  </div>
                </div>
              </li>
              ...
              <li className="text-left">
                <div className="flex items-center">
                  <span className="mx-2 text-gray-400">/</span>
                  <div className="-m-1">
                    <a href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800" aria-current="page"> Brow Harmony Precision Pencil </a>
                  </div>
                </div>
              </li>
            </ol>
          ...
          <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
              <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl">Brow Harmony Precision Pencil</h1>
              ...
              <div className="flex items-center mt-4">
                            <button className="h-5 w-5 rounded-full bg-[#A68D77] border-2 border-blue-200 mr-2 focus:outline-none"></button>
                            <button className="h-5 w-5 rounded-full bg-[#9F8272] mr-2 focus:outline-none"></button>
                            <button className="h-5 w-5 rounded-full bg-[#7F553E] mr-2 focus:outline-none"></button>
                        </div>
      
        
<form className="">
  <label htmlFor="size" className="block mt-4 mb-2 text-sm font-medium text-gray-900">Select size</label>
    ...
    <option value="XL">Extra Large</option>
            ...
            <div className="lg:col-span-3 lg:row-end-1">
              <div className="lg:flex lg:items-start">
                <div className="lg:order-1 lg:ml-5">
                  <div className="max-w-xl overflow-hidden rounded-lg">
                    <img className="h-full w-full max-w-full object-cover" src="https://www.rarebeauty.com/cdn/shop/files/ECOMM-RARE-IMPACT-LIP-DUO-PRODUCT-BOX.jpg?v=1728679037" alt="" />
                  </div>
                </div>
      
                <div className="mt-2 w-full lg:order-2 lg:w-32 lg:flex-shrink-0">
                  <div className="flex flex-row items-start lg:flex-col">
                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                      <img className="h-full w-full object-cover" src="https://www.rarebeauty.com/cdn/shop/files/ECOMM-RARE-IMPACT-LIP-DUO-PRODUCT-BOX_120x120_crop_center.jpg?v=1728679037" alt="" />
                    </button>
                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                      <img className="h-full w-full object-cover" src="https://www.rarebeauty.com/cdn/shop/files/SWATCH-RARE-IMPACT-LIP-DUO_120x120_crop_center.jpg?v=1728679037" alt="" />
                    </button>
                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                      <img className="h-full w-full object-cover" src="https://www.rarebeauty.com/cdn/shop/files/ON-FIGURE-RI-LIP-DUO-NEARLY-PETAL-01_120x120_crop_center.jpg?v=1728679037" alt="" />
                    </button>
                  </div>
                </div>
              </div>
